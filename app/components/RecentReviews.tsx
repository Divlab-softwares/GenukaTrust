...
import { Review, sampleReviews as initialReviews } from '../data/sampleReviews';
        ...
        <AnimatePresence>
          {reviews.map((review, index) => (
            <motion.div
              ...
              animate="show"
              exit="exit"
              className={`group relative bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 ${!review.published
              ...
              <div className="flex items-start space-x-5">
                <motion.div
                  className={`shrink-0 w-14 h-14 rounded-2xl flex items-center justify-center text-white text-xl font-bold 
                    bg-gradient-to-br ${getRandomGradient(index)} shadow-md overflow-hidden`}
